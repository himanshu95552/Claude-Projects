...
export async function generatePost(
  ...
  const result = await callModel({ anthropicModel: model, system, prompt, cachedSystemPrefix: cachedPrefix, maxTokens: 4000 });
...
export async function generateXPost(
  ...
  const cachedPrefix = buildCachedSystemPrefix(input);
  const result = await callModel({ anthropicModel: model, system, prompt, cachedSystemPrefix: cachedPrefix, maxTokens: 2000 });
...
export async function generateComment(
  ...
  const cachedPrefix = buildCachedSystemPrefix(input);
  const result = await callModel({ anthropicModel: model, system, prompt, cachedSystemPrefix: cachedPrefix, maxTokens: 2500 });
...
export async function generateReply(
  ...
  const cachedPrefix = buildCachedSystemPrefix(input);
  const result = await callModel({ anthropicModel: model, system, prompt, cachedSystemPrefix: cachedPrefix, maxTokens: 1800 });
...
export async function generateConnectionNote(
  ...
  const cachedPrefix = buildCachedSystemPrefix(input);
  const result = await callModel({ anthropicModel: model, system, prompt, cachedSystemPrefix: cachedPrefix, maxTokens: 1200 });
